(ns tawami.methods.social
  "social.cljc — tawami DRY-RUN self-publication seed (ADR-2606272355, auto-seeded R0).

  This is a GENERIC self-publication projection (draft-observation-post below builds an
  app.bsky.feed.post-shaped record), mechanically derived from tawami's own
...
(defn draft-observation-post
  "A dry-run observation post over tawami's own domain (Proof-of-Flexibility asset KG — the flexibility leg of the Energy Order Protocol suite. The value here is not generation but the ABILITY TO…)."
...
(defn build-live
  ...
  [& _args]
  (throw (ex-info (str "tawami R0: live social posting is Council Lv6+ + operator + "
